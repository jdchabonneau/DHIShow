...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      {
        title: 'Administration', pageInfos: [{page: DummyPage, name: "Admin Approvals", pageType: 0 }, {page: DummyPage, name: "Create Billing", pageType: 0 }, {page: CustomersPage, name: "Customers", pageType: 0 },
        {page: DummyPage, name: "Items", pageType: 0 }, {page: LabelPrintersPage, name: "Label Printers", pageType: 0 }, {page: DummyPage, name: "Pallets", pageType: 0 }, {page: DummyPage, name: "Rate Tables", pageType: 0 },
        {page: DummyPage, name: "Settings", pageType: 0 }, {page: DummyPage, name: "Ship To's", pageType: 0 }, {page: DummyPage, name: "Special Charges", pageType: 0 }, {page: ShipViaPage, name: "Ship Via's", pageType: 0 },
        {page: DummyPage, name: "Users", pageType: 0 }, {page: DummyPage, name: "View Billing", pageType: 0 }, {page: WarehousesPage, name: "Warehouses", pageType: 0 }, ]
      },
